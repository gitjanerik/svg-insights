        ...
        if (el.type === 'way' && el.geometry) {
          ...
          if (code === '521' && areaM2 < 500) {
            ...
            if (closed) {
              ...
              // (ingen Z). 0.8 mm non-scaling-stroke (CSS-regelen gjør den
              ...
              // 0.8 mm holder den lesbar uten å dominere i den tilstanden.
              let line = projPts
              ...
              strokeOnlyStyle = 'fill:none;stroke:#6b6b6b;stroke-width:0.8mm;stroke-linejoin:round;stroke-linecap:round'
            }
          } else {
