          ...
          <div class="relative">
            ...
            <details class="group" open>
              <summary class="text-sm text-white/65 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-white text-base">7.3.5</span>
                <span class="text-emerald-300/85">&mdash; debug-panel for multiball</span>
              ...
              <ul class="mt-2 text-xs text-white/55 space-y-1.5 list-disc list-inside">
                <li>DBG-knapp i HUD viser live ball-tilstand (stillTime, charge, hist, v) + event-logg</li>
                <li>«FORCE MULTIBALL»-knapp tvinger trigger uavhengig av stillness-detektor</li>
                <li>Midlertidig — fjernes når feilen er bekreftet løst</li>
              </ul>
            </details>
          </div>
