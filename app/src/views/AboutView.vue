...
<template>
  <div class="min-h-[100dvh] bg-stone-50 text-zinc-700">

    <!-- Header -->
    <header class="flex items-center justify-between px-4 py-3 bg-white border-b border-zinc-200">
      <button @click="router.push('/')" class="text-zinc-600 active:text-white transition-colors">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/>
        </svg>
      </button>
      <h1 class="text-sm font-medium text-zinc-800">Om SVG Insights</h1>
      <div class="w-6" />
    </header>
    ...
    <div class="max-w-lg mx-auto px-6 py-8 space-y-8">
      ...
      <div class="text-center">
        ...
        <p class="text-xs text-zinc-400 mt-1">Versjon {{ APP_VERSION }}</p>
      </div>

      <!-- About -->
      <section>
        <h3 class="text-sm font-semibold text-zinc-600 uppercase tracking-wider mb-3">Om appen</h3>
        <p class="text-sm text-zinc-600 leading-relaxed">
          SVG Insights er et lekent vektor-laboratorium med tre hovedfunksjoner:
        </p>
        <ul class="text-sm text-zinc-600 mt-2 space-y-1.5 list-disc list-inside leading-relaxed">
          <li><strong class="text-zinc-700">Lag SVG-tegning</strong> — konverter bilder til interaktive strektegninger</li>
          <li><strong class="text-zinc-700">Lag webfont</strong> — bygg din egen .otf-font fra glyf-tegninger</li>
          <li><strong class="text-zinc-700">Vis turkart</strong> — ISOM-inspirerte sportskart i SVG generert fra åpne norske data</li>
        </ul>
        <p class="text-sm text-zinc-500 mt-3">Lansert 8. april 2026 · turkart-funksjonen lagt til 6. mai 2026</p>
      </section>

      <!-- Team -->
      <section>
        <h3 class="text-sm font-semibold text-zinc-600 uppercase tracking-wider mb-3">Utviklere</h3>
      ...
      <section>
        <h3 class="text-sm font-semibold text-zinc-600 uppercase tracking-wider mb-3">Bilde til SVG — slik fungerer det</h3>
        <p class="text-sm text-zinc-600 leading-relaxed">
        ...
        <ol class="text-sm text-zinc-500 mt-3 space-y-1.5 list-decimal list-inside">
      ...
      <!-- Turkart-pipeline -->
      <section>
        <h3 class="text-sm font-semibold text-zinc-600 uppercase tracking-wider mb-3">Turkart — ISOM-inspirert pipeline</h3>
        <p class="text-sm text-zinc-600 leading-relaxed">
        ...
        <h4 class="text-xs font-semibold text-zinc-600 mt-4 mb-2">Datakilder (alle CC BY 4.0 / ODbL)</h4>
        <ul class="text-xs text-zinc-500 space-y-1.5 list-disc list-inside leading-relaxed">
          <li><strong class="text-zinc-700">OpenStreetMap</strong> via Overpass API — stier, veier, vann, bygninger, stedsnavn, øy-overlay</li>
          <li><strong class="text-zinc-700">Kartverket N50 Kartdata</strong> via WFS — autoritativ Havflate, Innsjø og ElvBekk</li>
          <li><strong class="text-zinc-700">Kartverket Sjøkart Dybdedata</strong> via WFS — kystkonturer, dybdeareal, dybdekurver, skjær, lanterner</li>
          <li><strong class="text-zinc-700">Kartverket DTM 1m/10m</strong> via WCS — terrengmodell for høydekurver og stupkanter</li>
          <li><strong class="text-zinc-700">Kartverket DOM 1m/10m</strong> via WCS — overflatemodell for vegetasjons-tetthet</li>
          <li><strong class="text-zinc-700">Nominatim</strong> via OSM — stedssøk i kart-velgeren</li>
        </ul>

        <h4 class="text-xs font-semibold text-zinc-600 mt-4 mb-2">Pipeline (fra OSM/N50/Sjøkart/DEM til ISOM-SVG)</h4>
        <ol class="text-xs text-zinc-500 space-y-1.5 list-decimal list-inside leading-relaxed">
        ...
        <h4 class="text-xs font-semibold text-zinc-600 mt-4 mb-2">Open source-bibliotek brukt i pipelinen</h4>
        <div class="grid grid-cols-2 gap-2 mt-2">
          <div class="bg-white/5 rounded-lg px-3 py-2 border border-zinc-100">
            <p class="text-[11px] font-medium text-zinc-600">d3-contour</p>
            <p class="text-[10px] text-zinc-400">Høydekurver fra DTM</p>
          </div>
          <div class="bg-white/5 rounded-lg px-3 py-2 border border-zinc-100">
            <p class="text-[11px] font-medium text-zinc-600">geotiff.js</p>
            <p class="text-[10px] text-zinc-400">GeoTIFF-parsing</p>
          </div>
          <div class="bg-white/5 rounded-lg px-3 py-2 border border-zinc-100">
            <p class="text-[11px] font-medium text-zinc-600">graphology</p>
            <p class="text-[10px] text-zinc-400">Routing-graf</p>
          </div>
          <div class="bg-white/5 rounded-lg px-3 py-2 border border-zinc-100">
            <p class="text-[11px] font-medium text-zinc-600">polygon-clipping</p>
            <p class="text-[10px] text-zinc-400">Boolean union (522)</p>
          </div>
          <div class="bg-white/5 rounded-lg px-3 py-2 border border-zinc-100">
            <p class="text-[11px] font-medium text-zinc-600">rbush</p>
            <p class="text-[10px] text-zinc-400">R-tree spatial index</p>
          </div>
          <div class="bg-white/5 rounded-lg px-3 py-2 border border-zinc-100">
            <p class="text-[11px] font-medium text-zinc-600">simplify-js</p>
            <p class="text-[10px] text-zinc-400">Douglas-Peucker</p>
          </div>
        </div>
      ...
      <!-- Tech stack -->
      <section>
        <h3 class="text-sm font-semibold text-zinc-600 uppercase tracking-wider mb-3">Teknologi</h3>
        <div class="grid grid-cols-2 gap-2">
          <div class="bg-white/5 rounded-lg px-3 py-2 border border-zinc-100">
            <p class="text-xs font-medium text-zinc-600">Vue 3</p>
            <p class="text-[10px] text-zinc-400">UI-rammeverk</p>
          </div>
          <div class="bg-white/5 rounded-lg px-3 py-2 border border-zinc-100">
            <p class="text-xs font-medium text-zinc-600">Vue Router</p>
            <p class="text-[10px] text-zinc-400">Navigasjon</p>
          </div>
          <div class="bg-white/5 rounded-lg px-3 py-2 border border-zinc-100">
            <p class="text-xs font-medium text-zinc-600">Vite</p>
            <p class="text-[10px] text-zinc-400">Byggeverktøy</p>
          </div>
          <div class="bg-white/5 rounded-lg px-3 py-2 border border-zinc-100">
            <p class="text-xs font-medium text-zinc-600">Tailwind CSS 4</p>
            <p class="text-[10px] text-zinc-400">Styling</p>
          </div>
          <div class="bg-white/5 rounded-lg px-3 py-2 border border-zinc-100">
            <p class="text-xs font-medium text-zinc-600">Vitest</p>
            <p class="text-[10px] text-zinc-400">Testing</p>
          </div>
          <div class="bg-white/5 rounded-lg px-3 py-2 border border-zinc-100">
            <p class="text-xs font-medium text-zinc-600">Ren JavaScript</p>
            <p class="text-[10px] text-zinc-400">Bildeprosessering</p>
          </div>
        </div>
        <p class="text-[11px] text-zinc-400 mt-3">
      ...
      <section v-if="false">
        <h3 class="text-sm font-semibold text-zinc-600 uppercase tracking-wider mb-4">Endringslogg</h3>
        <div class="relative pl-5 border-l border-zinc-200 space-y-4">

          <!-- 6.16.0 -->
          <div class="relative">
            <div class="absolute -left-[1.3rem] top-1 w-2.5 h-2.5 rounded-full bg-amber-700" />
            <details class="group" open>
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.16.0</span>
                <span class="text-zinc-500">&mdash; UX-rydding: lyst tema, FAB-zoom, kvadratisk frame, PDF, rotasjon</span>
                <span class="ml-auto text-[10px] text-zinc-400 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.15.1</span>
                <span class="text-zinc-500">&mdash; Trigpunkt-overlay på peak-noder + flere OSM-tag-varianter</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.15.0</span>
                <span class="text-zinc-500">&mdash; Trigpunkter + sjømerker (lateral/cardinal/spesial) + finjustering</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.14.3</span>
                <span class="text-zinc-500">&mdash; Hule (ISOM 215) + gruve (ISOM 216) som point-symboler</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.14.2</span>
                <span class="text-zinc-500">&mdash; Halverte jernbane-bredder + tunnel-opacity</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.14.1</span>
                <span class="text-zinc-500">&mdash; Tunnel-fantom for jernbane + portal-markører</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.14.0</span>
                <span class="text-zinc-500">&mdash; Jernbane (ISOM 515) + finere stitråkk-dots</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.13.4</span>
                <span class="text-zinc-500">&mdash; Fremhevede stier med staccato-dash + dotted stitråkk</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.13.3</span>
                <span class="text-zinc-500">&mdash; Halverte strektykkelser + moh på alle tjern</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.13.2</span>
                <span class="text-zinc-500">&mdash; Lesbare navn-labels + utvidet zoom + flere stedsnoder</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.13.0</span>
                <span class="text-zinc-500">&mdash; Vinter-pakke: lysløyper, heistrasé, slalombakker + halverte stupkant-bredder</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.12.2</span>
                <span class="text-zinc-500">&mdash; Tynnere stier + bedre OSM-klassifisering: Sognsvann/Marka skiller nå mellom DNT-merket sti og knapt synlig tråkk</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.12.1</span>
                <span class="text-zinc-500">&mdash; «Confirmed inland»-deteksjon: stopper sjøblå-lekkasje i Drammen, Hokksund og andre fjord-hode-områder</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.12.0</span>
                <span class="text-zinc-500">&mdash; ISOM-symbol-pakke: tydelige sti-typer, print-faithful tegnforklaring, synlige annoteringer + GPS-dot</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.11.2</span>
                <span class="text-zinc-500">&mdash; Dynamisk skjerm-skalering: annoteringer + GPS-dot er nå alltid synlig (skala-uavhengig)</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.11.1</span>
                <span class="text-zinc-500">&mdash; Annoteringssymboler skikkelig synlige nå (unitless user-units + halo-bakgrunn)</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.11.0</span>
                <span class="text-zinc-500">&mdash; ISOM-polish: tydeligere skille mellom sti-typer, høydekurver matcher tegnforklaring eksakt, annoteringssymboler virker igjen</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.10.4</span>
                <span class="text-zinc-500">&mdash; Filtrer OSM saltvann-relations i coastline-mode (de blødde over mainland)</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.10.3</span>
                <span class="text-zinc-500">&mdash; Bedre øy-deteksjon: pier/breakwater, place=island-relations med tom rolle, Sjøkart-diagnostikk</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.10.2</span>
                <span class="text-zinc-500">&mdash; Reintroduserer coastline-rekonstruksjon: blått hav i Oslo og Nesøya</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.10.1</span>
                <span class="text-zinc-500">&mdash; Granulært vann-filter: behold OSM Oslofjord når N50 bare har innsjøer</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.10.0</span>
                <span class="text-zinc-500">&mdash; Kystkart: Sjøkart-WFS gir blått hav, dybdekurver, skjær og lanterner</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.9.0</span>
                <span class="text-zinc-500">&mdash; ISOM-polish: sykkel-sti, navn-toggle, Tegnforklaring-side, zoom</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.8.4</span>
                <span class="text-zinc-500">&mdash; ROTÅRSAKEN funnet: OSM multipolygon-relations syes nå sammen til lukkede ringer</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.8.3</span>
                <span class="text-zinc-500">&mdash; Visuell diagnose-modus: fargelegg polygoner etter kilde</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.8.2</span>
                <span class="text-zinc-500">&mdash; Per-feature path (ingen evenodd cross-cancellation) + data-src diagnose</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.8.1</span>
                <span class="text-zinc-500">&mdash; Wedge-bug rotårsak: polygon-clipping CCW-orientering + MultiPolygon-flatten</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.8.0</span>
                <span class="text-zinc-500">&mdash; Drastisk opprydning: fjerner coastline-polygonisering helt</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.7.1</span>
                <span class="text-zinc-500">&mdash; Hestesund-fix: alltid filtrer OSM coastline uansett N50-suksess</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.7.0</span>
                <span class="text-zinc-500">&mdash; Stupkant-trekanter (ISOM 203 teeth) + N50 utstreknings-validering</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.6.1</span>
                <span class="text-zinc-500">&mdash; Land-mask for bymasse + vegetasjon (klipper OSM-polygoner mot N50 vann-grense)</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.6.0</span>
                <span class="text-zinc-500">&mdash; Kartverket N50 som autoritativ vann-kilde (Havflate, Innsjø, ElvBekk)</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.5.8</span>
                <span class="text-zinc-500">&mdash; Coastal-modus krever nå at minst én åpen kystlinje-arc krysser bbox-kanten</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.5.7</span>
                <span class="text-zinc-500">&mdash; Backup-deteksjon: place=island/islet polygoner brukes som land-ringer</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.5.6</span>
                <span class="text-zinc-500">&mdash; Mjøsa-fix: filtrer ut store lukkede coastline-ringer (lake-mistag), og bedre chain-merging</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.5.5</span>
                <span class="text-zinc-500">&mdash; Snudd masking-strategi: land som default, sjø som overlay (sea = bbox − land)</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.5.4</span>
                <span class="text-zinc-500">&mdash; Reparert kystlinje-orientering: land vises nå korrekt over sjø</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.5.3</span>
                <span class="text-zinc-500">&mdash; Vann-polygoner med samme navn slås sammen</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.5.2</span>
                <span class="text-zinc-500">&mdash; Kystlinje-polygonisering: ekte sjø-bakgrunn for kystkart</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.5.1</span>
                <span class="text-zinc-500">&mdash; Bredere saltvann-deteksjon: navn-heuristikk, place=sea, natural=bay/strait</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.5.0</span>
                <span class="text-zinc-500">&mdash; Kart-polish: bymasse under vann, høyde-labels i innsjøer, saltvann skiller seg fra ferskvann</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.4.0</span>
                <span class="text-zinc-500">&mdash; LiDAR-derivert vegetasjons-klassifisering: ISOM 405–408 grønnskala fra ekte canopy-høyde</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.3.0–6.3.3</span>
                <span class="text-zinc-500">&mdash; ISOM 522 tett bebyggelse + bruker-velgbar ekvidistanse + 5m default</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.2.0–6.2.4</span>
                <span class="text-zinc-500">&mdash; Ekte stupkant-vectorisering med Zhang-Suen + tunet forenkling</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.1.0–6.1.1</span>
                <span class="text-zinc-500">&mdash; Ekte Kartverket DTM via WCS + multi-endpoint fallback</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.0.2</span>
                <span class="text-zinc-500">&mdash; Brukertest-forbedringer for høydekurver, knapper og vann-maske</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">6.0.0</span>
                <span class="text-zinc-500">&mdash; ISOM-inspirert turkart-pipeline med høydekurver, N50, routing og print</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">5.2.0</span>
                <span class="text-zinc-500">&mdash; Lag ditt eget turkart: stedssøk, bbox-velger og IndexedDB-lagring</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">7. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">5.1.0</span>
                <span class="text-zinc-500">&mdash; Turkart-sporet: Vardåsen i Asker som SVG med GPS og kompass</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">6. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">5.0.2</span>
                <span class="text-zinc-500">&mdash; Endringslogg skjult fra About-siden</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">6. mai 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">5.0.1</span>
                <span class="text-zinc-500">&mdash; Webfont-pakken: tegne-modus, variable innstillinger og smartere editor</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">30. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
                <li><strong class="text-zinc-600">Ny tegne-modus</strong> i glyf-editoren med kalligrafisk pensel — slidere for tykkelse og rundhet (klassisk 35°-vinkel ved lav rundhet), lukket-deteksjon (slutt nær start lager en ring), &laquo;Angre strek&raquo; og bezier-glatting ved lagring</li>
                <li><strong class="text-zinc-600">Boolean-union</strong> ved lagring — overlappende strøk og eksisterende vektorer slås sammen til én sammenhengende form med riktig håndtering av hull</li>
                <li><strong class="text-zinc-600">Tre nye variable innstillinger</strong> i naming-steget: Bredde (kondensert/strakt 70&ndash;130%), Håndlaget (deterministisk jitter for skissete preg) og Vekt-finjustering (post-tracing offset uavhengig av Google-fontens egne vekter)</li>
                <li><strong class="text-zinc-600">Glyf-funnet-forhåndsvisning</strong> ved foto-tracing — bilde og sporet glyf vises side ved side med statusmelding før du bekrefter, og støy/rammer filtreres bort på forhånd</li>
                <li><strong class="text-zinc-600">Smartere seleksjon i editoren</strong>: sletting velger nærmeste gjenværende punkt, tillegg velger nye punktet — slipper å re-tappe</li>
                <li><strong class="text-zinc-600">Ny Tøm-knapp</strong> i quick-actions sletter alle vektorer i glyfen (angrebar)</li>
                <li><strong class="text-zinc-600">Tykkere/Tynnere skrevet om</strong> &mdash; bruker nå left-normal-offset per subpath i stedet for sentroid-skalering. Endrer faktisk vekt på formene istedenfor å skalere hele glyfen</li>
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">4.14.2</span>
                <span class="text-zinc-500">&mdash; Rull tilbake kontur-smoothing</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">23. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800 line-through">4.14.1</span>
                <span class="text-zinc-500">&mdash; Rullet tilbake i 4.14.2</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">23. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group" open>
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">4.14.0</span>
                <span class="text-zinc-500">&mdash; Utvidet fontkatalog (+48 Google Fonts)</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">23. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
                <li>Fontvalg tredoblet fra 8 til <strong class="text-zinc-600">24 per kategori</strong> (totalt 72 fonter)</li>
                <li><strong class="text-zinc-600">Serif</strong>: Cormorant Garamond, Crimson Pro, Cardo, Zilla Slab, Abril Fatface, Alegreya, Spectral, DM Serif Display, Fraunces, Noto Serif, PT Serif, Cinzel, Libre Caslon, Josefin Slab, Old Standard TT, Rozha One</li>
                <li><strong class="text-zinc-600">Sans-serif</strong>: Oswald, Raleway, Bebas Neue, Archivo, Barlow, Fira Sans, DM Sans, Space Grotesk, Manrope, Karla, Rubik, Josefin Sans, Archivo Narrow, PT Sans, Exo 2, Quicksand</li>
                <li><strong class="text-zinc-600">H&aring;ndskrift</strong>: Great Vibes, Sacramento, Permanent Marker, Kaushan Script, Homemade Apple, Yellowtail, Cookie, Allura, Parisienne, Lobster, Marck Script, Patrick Hand, Rock Salt, Architects Daughter, Special Elite, Courgette</li>
          ...
          <div class="relative">
            ...
            <details class="group" open>
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">4.13.3</span>
                <span class="text-zinc-500">&mdash; Hamburgefons som standard-preview</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">23. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group" open>
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">4.13.2</span>
                <span class="text-zinc-500">&mdash; Editor-opprydding + edited-status-fiks</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">23. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
                ...
                <li><strong class="text-zinc-600">Fikset edited-status</strong>: redigerte glyfer forble «auto» (bl&aring;) pga. bug i status-logikken. N&aring; markeres de riktig som «edited» (gr&oslash;nn) etter f&oslash;rste justering</li>
              </ul>
            </details>
          </div>
          ...
          <div class="relative">
            ...
            <details class="group" open>
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">4.13.1</span>
                <span class="text-zinc-500">&mdash; Crop-hjørner + Outline-modus</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">23. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
                <li><strong class="text-zinc-600">Drabare crop-hjørner aktiverte</strong> &mdash; touch-handler p&aring; hjørnene stjal eventen uten &aring; gj&oslash;re noe; fallthrough til gestur-laget l&oslash;st</li>
                <li>Startstørrelse p&aring; crop-boksen redusert til 2/3 for bedre balanse mot bildet</li>
                <li><strong class="text-zinc-600">Avbryt-knapp</strong> i crop-footeren (i tillegg til «Ta nytt» og «Bruk utsnitt»)</li>
                <li><strong class="text-zinc-600">Vekt, Kursiv, Outline</strong> flyttet til naming-steget i FontChooser &mdash; settes f&oslash;r generering starter</li>
                <li><strong class="text-zinc-600">Outline-modus</strong>: canvas tegner <code>strokeText()</code> istedenfor <code>fillText()</code> &mdash; sporer konturlinjen av hvert strek, ikke det fylte glyffet</li>
          ...
          <div class="relative">
            ...
            <details class="group" open>
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">4.13.0</span>
                <span class="text-zinc-500">&mdash; Variabel font + crop-fiks</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">23. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
                <li><strong class="text-zinc-600">Vekt-slider (100–900)</strong> i FontCapture — laster variabel Google Font med full vekt-range; glyfer regenereres med valgt tykkelse</li>
                <li><strong class="text-zinc-600">Kursiv-toggle</strong> — aktiverer italics-variant av fonten der det er tilgjengelig (<code>hasItal</code>)</li>
                <li><strong class="text-zinc-600">Regenerer-knapp</strong> dukker opp n&aring;r innstillinger endres etter f&oslash;rste generering; regenererer kun <code>auto</code>-glyfer (bevarer redigerte)</li>
                <li><strong class="text-zinc-600">Drabare hjørner i crop-dialogen</strong> — L-formede h&aring;ndtak med 44 px touch-target; dra hjørner for &aring; justere utsnittet fritt</li>
          ...
          <div class="relative">
            ...
            <details class="group" open>
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">4.12.9</span>
                <span class="text-zinc-500">&mdash; Glyf-editor: dra-fiks</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">23. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">4.12.8</span>
                <span class="text-zinc-500">&mdash; MinFont: glyf-tracing og proporsjoner</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">23. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
                <li>Ny contour-tracer skiller n&aring; ytre form fra hull &mdash; <strong class="text-zinc-700">A, B, D, O, P, R, 0, 4, 6, 8, 9, a, b, d, e, g, o, p, q</strong> f&aring;r riktige &aring;pninger</li>
                ...
                <li>Felles <strong class="text-zinc-700">cap-height referanse</strong>: alle glyfer skaleres mot samme baseline og cap-h&oslash;yde, s&aring; proporsjonene mellom bokstavene er harmoniske (et 'i' er smalt, et 'M' er bredt)</li>
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">4.12.7</span>
                <span class="text-zinc-500">&mdash; MinFont: forh&aring;ndsvisning + foto-dialog</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">23. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
                <li>Ny <strong class="text-zinc-700">Forh&aring;ndsvis font</strong>-side med levende typografi-kontroller: fontst&oslash;rrelse, linjeh&oslash;yde, sperring, ordavstand, justering og bokstavform</li>
                <li>Rask utforsking via presets: Display, Overskrift, Br&oslash;dtekst, Nullstill</li>
                <li>Alltid synlig gul <strong class="text-zinc-700">Forh&aring;ndsvis font</strong>-knapp nederst p&aring; glyf-oversikten</li>
                <li>GlyphPhotoDialog: fast 4&times;5 crop-ramme + dra/klyp for &aring; plassere bildet under (erstattet draghj&oslash;rner)</li>
                <li>Hjelpestreker for <strong class="text-zinc-700">grunnlinje</strong> (1/5 fra bunn) og <strong class="text-zinc-700">x-h&oslash;yde</strong> (2/5 fra bunn) som guide for plassering</li>
              </ul>
            </details>
          </div>
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">4.12.6</span>
                <span class="text-zinc-500">&mdash; Planetarium-UX</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">22. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
                <li>Ny <strong class="text-zinc-700">konfigurer-knapp</strong> nederst til h&oslash;yre i planetarium-modus &mdash; &aring;pner modalen med gjeldende sol slik at du kan justere og regenerere</li>
                <li>Planet-tap endrer n&aring; banen <strong class="text-zinc-700">tilfeldig &plusmn;1</strong> &mdash; fjernet keyboard-modifiers som ikke fungerte p&aring; mobil</li>
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">4.12.5</span>
                <span class="text-zinc-500">&mdash; Planetarium-fiks</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">22. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
                <li>Solsystem-modus har n&aring; alltid <strong class="text-zinc-700">sort bakgrunn</strong>, uavhengig av valgt bakgrunnsfarge</li>
                <li>Planeter rendres n&aring; <strong class="text-zinc-700">oppå sola</strong> &mdash; indre baner er synlige selv n&aring;r de krysser solskiven</li>
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">4.12.4</span>
                <span class="text-zinc-500">&mdash; Avrunding-fiks, Kepler-rename, Installer-knapp</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">22. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
                <li>Avrunding bruker n&aring; en <strong class="text-zinc-700">feMorphology-opening</strong> (erode &rarr; dilate) i stedet for path-geometri &mdash; gir synlig og konsistent effekt</li>
                <li>Fill-effekter kan n&aring; stables (Forenkling + Avrunding + Fragmentering sammen) via nested filter-grupper</li>
                <li>&laquo;Rastafari&raquo; heter n&aring; <strong class="text-zinc-700">Kepler</strong> &mdash; passer bedre sammen med Einstein i astronomi-temaet</li>
                <li>Ny <strong class="text-zinc-700">Installer app</strong>-knapp p&aring; forsiden som utl&oslash;ser nettleserens install-prompt direkte</li>
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">4.12.2</span>
                <span class="text-zinc-500">&mdash; Synlig Installer-knapp (ble rullet inn i 4.12.4)</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">22. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
                <li>Avrunding bruker n&aring; en <strong class="text-zinc-700">feMorphology-opening</strong> (erode &rarr; dilate) i stedet for path-geometri &mdash; gir synlig og konsistent effekt</li>
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">4.12.1</span>
                <span class="text-zinc-500">&mdash; Kamera-redesign + planetarium-exit</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">22. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
                <li>Kamera-fanen heter n&aring; <strong class="text-zinc-700">"Ta bilde eller last opp"</strong></li>
                <li>Sentrert shutter-knapp, opplasting til venstre, ny <strong class="text-zinc-700">flip-knapp</strong> til h&oslash;yre (bytter til selfie-kamera)</li>
                <li>Ny <strong class="text-zinc-700">zoom-slider</strong> &mdash; bruker native MediaTrack-zoom n&aring;r tilgjengelig, ellers digital zoom via canvas-crop</li>
                ...
                <li>I planetarium-modus skjules drawer &mdash; <strong class="text-zinc-700">X-knapp &oslash;verst til h&oslash;yre</strong> avslutter scenen</li>
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">4.12.0</span>
                <span class="text-zinc-500">&mdash; Nye presets og felt-effekter</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">22. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
                <li>Fem nye presets: <strong class="text-zinc-700">Nullstill</strong> (&oslash;verst), <strong class="text-zinc-700">Warhol</strong>, <strong class="text-zinc-700">Tegneserie</strong>, <strong class="text-zinc-700">Kepler</strong> og <strong class="text-zinc-700">Einstein</strong></li>
                <li>Presets kan n&aring; aktivere halftone, fargelegging, interaktivitet og Strek-effekter i &eacute;n handling</li>
                <li>Fire nye felt-effekter i <strong class="text-zinc-700">Farge</strong>-fanen, hver med av/p&aring;-bryter:
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">4.11.1</span>
                <span class="text-zinc-500">&mdash; Flex-basert drawer-layout</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">22. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
                ...
                <li>Drawer kan n&aring; <strong class="text-zinc-700">kun &aring;pnes/lukkes ved drag</strong> &mdash; tap p&aring; handle gj&oslash;r ingenting</li>
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">4.11.0</span>
                <span class="text-zinc-500">&mdash; Drawer-forankring og fem nye strek-effekter</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">22. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
                <li>Mobilt drawer er tilbake til <strong class="text-zinc-700">45 vh</strong> som standard, og viser kun drawer-leppen n&aring;r den er minimert</li>
                <li>Knappene (rotering + nullstill) og zoom-statsen <strong class="text-zinc-700">f&oslash;lger drawer-toppen</strong> &mdash; alltid like over panelet</li>
                ...
                <li>Fem nye effekter i <strong class="text-zinc-700">Strek</strong>-fanen, hver med av/p&aring;-bryter og reversibel virkning:
                  <ul class="ml-4 mt-1 space-y-0.5">
                ...
                <li>Pluss to alltid-p&aring;-slidere: <strong class="text-zinc-700">transparens p&aring; strek</strong> og <strong class="text-zinc-700">transparens p&aring; skravering</strong></li>
              </ul>
            </details>
          </div>
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">4.10.0</span>
                <span class="text-zinc-500">&mdash; Drag-drawer og live statistikk</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">22. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
                <li><strong class="text-zinc-700">Streker-teller</strong> ved siden av zoom-nivået viser antall synlige streker i tegningen</li>
                <li>Når farger er aktivert, vises også <strong class="text-zinc-700">antall fargede områder</strong> — teller opp etter hvert som de reveales</li>
                <li>Tekstfarge for statistikken tilpasses bakgrunnsfargen automatisk (mørk tekst på lys bakgrunn, lys tekst på mørk)</li>
                <li>Mobilt kontrollpanel er nå en <strong class="text-zinc-700">drag-drawer</strong>: swipe opp/ned for å minifisere eller ekspandere</li>
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">4.9.1</span>
                <span class="text-zinc-500">&mdash; PWA + fiks av modal-scroll</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">22. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
                <li>Appen er nå en <strong class="text-zinc-700">Progressive Web App (PWA)</strong> &mdash; installer på hjemskjermen og bruk den som en vanlig app</li>
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">4.9.0</span>
                <span class="text-zinc-500">&mdash; Planetarium-oppsett: du styrer solsystemet</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">22. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
                <li>Når «Sort hull» er ferdig, dukker det nå opp en <strong class="text-zinc-700">konfigureringsmodal</strong> før planetariet starter</li>
                ...
                <li><strong class="text-zinc-700">Klikk på en planet</strong> for å flytte den &eacute;n bane innover eller utover; måner følger med</li>
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">4.8.6</span>
                <span class="text-zinc-500">&mdash; Lag webfont: helt nytt spor i appen</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">22. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
                <li>Ny funksjon: <strong class="text-zinc-700">Lag webfont</strong> &mdash; generer en egen <code class="text-zinc-600">.otf</code>-font ved å velge en inspirasjons-Google-font og evt. ta bilder av enkeltbokstaver</li>
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">2.1.2</span>
                <span class="text-zinc-500">&mdash; Romtema: Magnet &rarr; Gravitasjon</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">14. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
                <li>Interaktiv modus «Magnet» er omdøpt til <strong class="text-zinc-700">Gravitasjon</strong> for å passe bedre med rom-temaet</li>
              </ul>
            </details>
          </div>
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-700">2.1.1</span>
                <span class="text-zinc-500">&mdash; Mobil-fiks: «Last opp»-knappen</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">14. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
                <li>Fiks: «Last opp»-knappen på mobil åpnet kameraet i stedet for galleri/filvelger. Fjernet <code class="text-zinc-600">capture="environment"</code>-attributtet slik at nettleseren nå viser vanlig filvelger med tilgang til galleriet.</li>
              </ul>
            </details>
          </div>
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2 flex-wrap">
                <span class="font-semibold text-zinc-800">2.1.0</span>
                <span class="text-zinc-500">&mdash; Interaktive rasterpunkter og nye presets</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">14. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
                ...
                <li><strong class="text-zinc-700">Gamification &mdash; interaktivt rasterlag:</strong>
                ...
                <li>Under panseret: <code class="text-zinc-600">computeHalftoneDots()</code> eksportert for gjenbruk, ny <code class="text-zinc-600">useHalftoneGame</code>-composable</li>
              </ul>
            </details>
          </div>
          ...
          <div class="relative">
            <div class="absolute -left-[1.3rem] top-1 w-2.5 h-2.5 rounded-full bg-violet-500" />
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2">
                <span class="font-semibold text-zinc-700">1.1.5</span>
                <span class="text-zinc-500">&mdash; Sammenslåing av rasterpunkter</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">9. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2">
                <span class="font-semibold text-zinc-700">1.1.4</span>
                <span class="text-zinc-500">&mdash; Smartere tegn-etter-tall og nytt nullstill-ikon</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">9. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2">
                <span class="font-semibold text-zinc-700">1.1.3</span>
                <span class="text-zinc-500">&mdash; App-layout og flytende kontroller</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">9. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2">
                <span class="font-semibold text-zinc-700">1.1.2</span>
                <span class="text-zinc-500">&mdash; Bakgrunnsfarge, fargevalg og rotering</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">9. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2">
                <span class="font-semibold text-zinc-700">1.1.1</span>
                <span class="text-zinc-500">&mdash; Forbedret rasterpunkter og tegn-etter-tall</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">9. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2">
                <span class="font-semibold text-zinc-700">1.0.2</span>
                <span class="text-zinc-500">&mdash; Nye effekter og buggfikser</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">9. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2">
                <span class="font-semibold text-zinc-700">1.0.1</span>
                <span class="text-zinc-500">&mdash; Fargelegging og tegn-etter-tall</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
          ...
          <div class="relative">
            ...
            <details class="group">
              <summary class="text-sm text-zinc-600 cursor-pointer list-none flex items-start gap-2">
                <span class="font-semibold text-zinc-700">1.0.0</span>
                <span class="text-zinc-500">&mdash; Første lansering</span>
                <span class="ml-auto text-[10px] text-zinc-300 shrink-0">8. apr 2026</span>
              </summary>
              <ul class="mt-2 text-xs text-zinc-500 space-y-1 list-disc list-inside">
