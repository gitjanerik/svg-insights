...
const SECTIONS = [
  ...
  { title: 'Parkering & service', codes: ['534', '534u', '560'], category: 'manmade',
    note: 'Utfartsparkering (offentlig, med sti innen 50 m) får grønn ramme rundt det blå P-skiltet og er 50 % større — den er nesten alltid foretrukket når man skal ut i marka. Vanlig/privat parkering er blå.' },
