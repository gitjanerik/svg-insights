...
const SECTIONS = [
  ...
  { title: 'Sjøkart 🌊 — for padling/båt', codes: ['307', '306', '211', '533', '540', '541', '542', '543', '550', '551', '552'], categoryMap: { '307': 'water', '306': 'water', '211': 'rock', '533': 'manmade', '540': 'manmade', '541': 'manmade', '542': 'manmade', '543': 'manmade', '550': 'manmade', '551': 'manmade', '552': 'manmade' },
    note: 'Dybdeareal får per-polygon-shading basert på dybde (lys = grunt, mørk = dypt). 550 (slipp) er kajakk-launch, 551 omfatter kai/brygge/pir/molo, 552 er fareområde. Krever at Kartverket Sjøkart-WFS svarer.' },
